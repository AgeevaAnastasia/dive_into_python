...
#from datetime import timedelta уже есть выше
delta1 = timedelta(weeks=53, days=500, hours=73, minutes=101, seconds=303, milliseconds=67890, microseconds=1234567)
